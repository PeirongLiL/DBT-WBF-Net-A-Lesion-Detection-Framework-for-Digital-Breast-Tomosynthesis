...
df = read_boxes(boxes_fp="data/boxes-val.csv", filepaths_fp="data/file-paths-val.csv")#读取了box和地址参数，并一起返回
...
def copy_case_rgb_multi(view, client, episode, image_rgb, side, bbox_list, slice_index):
    ...
    with open(output_path + '/val_bboxes.csv', 'a+', newline='') as file:
